...
const Form = () => {
    ...
    const handleSubmit = async(e) => {
        e.preventDefault();
        setLoader(true);
        const storageRef = ref(storage, 'webfolio-projects'+file?.name);
  ...
  shadow-md mx-4 md:mx-56 lg:mx-72 p-5 rounded-md bg-slate-50"
  >
    ...
    font-extrabold text-blue-500"
      ...
      <input
        ...
        className="w-full mb-4 border-[1px] p-2 rounded-md bg-slate-200"
      />
      <textarea
        name="desc"
      ...
      <div className="grid grid-cols-2 mb-4 md:grid-cols-4">
